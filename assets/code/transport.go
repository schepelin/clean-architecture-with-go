...
func MakeGetImagehandler(
	svc uploader.UploadService,
) http.Handler {
...
func MakeRouter(
	...
	m.Handle(
		"/images",
		MakeUploadImageHandler(svc),
	).Methods("POST")
	m.Handle(
		"/images/{id}",
		MakeGetImageHandler(svc),
	).Methods("GET")
